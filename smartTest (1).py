...
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://smart-baby-monitor-d19e1.firebaseio.com/', 'storageBucket': 'gs://smart-baby-monitor-d19e1.appspot.com'
    })

#file = ('https://firebasestorage.googleapis.com/v0/b/smart-baby-monitor-d19e1.appspot.com/o/rockabyebaby.mp3?alt=media&token=5c1977f5-8493-43b1-a0a6-2671357bcb5b')

p = vlc.MediaPlayer('https://firebasestorage.googleapis.com/v0/b/smart-baby-monitor-d19e1.appspot.com/o/rockabyebaby.mp3?alt=media&token=5c1977f5-8493-43b1-a0a6-2671357bcb5b')
p.play()
p.stop()
